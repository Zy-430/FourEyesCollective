...
try {
    ...
    if ($paymentIntent->status === 'succeeded') {
        ...
        $_db->prepare("
            ...
            VALUES (?, ?, 'paid', NOW(), ?, 'Payment successful via Stripe')
        ...
        <head>
            ...
            <style>
                ...
                .btn-primary { background: #27ae60; }
                .order-details { text-align: left; background: #f8f9fa; padding: 25px; border-radius: 10px; margin: 30px 0; }
                .order-details h3 { color: #2c3e50; border-bottom: 2px solid #e0e0e0; padding-bottom: 10px; font-family: 'Playfair Display', serif; }
                .order-item { display: flex; align-items: center; padding: 15px; background: white; border-radius: 8px; margin: 10px 0; border: 1px solid #e0e0e0; }
                .order-item img { width: 60px; height: 60px; object-fit: cover; border-radius: 6px; margin-right: 15px; }
                .checkmark { font-size: 4rem; color: #27ae60; margin: 20px 0; }
                .order-info { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin: 20px 0; }
                .info-box { background: white; padding: 15px; border-radius: 8px; border: 1px solid #e0e0e0; }
                .info-label { color: #7f8c8d; font-size: 0.9rem; }
                .info-value { font-weight: bold; color: #2c3e50; margin-top: 5px; }
            </style>
        </head>
        <body>
            <div class="container">
        ...
        throw new Exception("Payment failed in Stripe. Status: " . $paymentIntent->status);
    }
    ...
    try {
        ...
        <head>
            ...
            <style>
                ...
                .info { background: #e3f2fd; color: #0d47a1; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 5px solid #2196f3; }
                .btn { display: inline-block; padding: 12px 25px; background: #2c3e50; color: white; text-decoration: none; border-radius: 5px; margin: 15px 10px; font-weight: bold; }
                .btn-primary { background: #27ae60; }
                .btn-secondary { background: #95a5a6; }
                .cancel-icon { font-size: 4rem; color: #e74c3c; margin: 20px 0; }
